...
public class Mid4Ball extends SequentialCommandGroup {
    public Mid4Ball(SwerveSubsystem m_swerve, IntakeSubsystem m_intake, ConveyorSubsystem m_conveyor, ShooterSubsystem m_shooter) {        
        ...
        PathPlannerTrajectory trajectory3 = PathPlanner.loadPath("MidCToB", 2.0, 3.0);
