...
public class Right5Ball extends SequentialCommandGroup {
    public Right5Ball(SwerveSubsystem m_swerve, IntakeSubsystem m_intake, ConveyorSubsystem m_conveyor, ShooterSubsystem m_shooter) {        
        ...
        addCommands(
            ...
            // Shoot the B ball
            new RunCommand(() -> m_conveyor.on(CONVEYOR.SHOOTSPEED), m_conveyor).withTimeout(AUTO.ONEBALLTIME)
